...
$( document ).on( "pagecontainerbeforechange" , function ( event, data ) {
    ...
    if ( data.toPage[0].id === "combo" ) {
        ...
        for (var k in menu["bebidas"].items) {
            ...
            $("#combobebidas").append("<label for='combobebidas"+k+"'>"+menu["bebidas"].items[k].nome+"<p style='text-align:right'>"+menu["bebidas"].items[k].preco+"</p></label>");
        ...
        for (var k in menu["acompanhamentos"].items) {
            ...
            $("#comboacompanhamentos").append("<label for='comboacompanhamentos"+k+"'>"+menu["acompanhamentos"].items[k].nome+"<p style='text-align:right'>"+menu["bebidas"].items[k].preco+"</p></label>");
